...
fun RegistrationForFindersScaffold(
    ...
    val backgroundColor = colorResource(R.color.registration_background_light)
    val primaryTextColor = colorResource(R.color.registration_primary_text)
    val secondaryTextColor = colorResource(R.color.registration_secondary_text)
    val primaryButtonColor = colorResource(R.color.registration_accent_teal)
    val secondaryButtonColor = colorResource(R.color.registration_accent_light_teal)
            ...
            Column(
                ...
                Button(
                    ...
                    Text(
                        ...
                        color = colorResource(R.color.registration_white)
                    )
                }
